...
export const LIBRARIAN_PROMPT_METADATA: AgentPromptMetadata = {
  ...
  keyTrigger: "External library/source mentioned → fire `librarian` along with othere explorers in the same `parallel_tasks` call",
  triggers: [
  ...
  useWhen: [
    ...
    "Working with unfamiliar npm/pip/cargo/nuget packages",
  ],
}
